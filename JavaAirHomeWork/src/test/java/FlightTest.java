...
public class FlightTest {
    ...
    @Test
    public void canCheckPilot(){
        assertEquals(pilot, flight.getPilot());
    }


    @Test
    public void canCheckCrewCount() {
        assertEquals(5, flight.getCrewCount());
    }
    ...
    public void canGetAvailableSeats(){
        assertEquals(464, flight.getAvailableSeats());
    }

//    @Test
//    public void canBookPassengerASeat(){
//        assertEquals("Booking Complete", flight.canBookPassengerASeat());
//
//    }

//    @Test
//    public void bookingPassengerAddsFlight(){
//        flight.bookPassenger(plane1, flight.getPassengers(), new Passenger("Jeff", 2));
//        assertEquals(4, flight.getAvailableSeats(flight.getPlane(), flight.getPassengers()));
//
//    }

    @Test
    public void canBookAvailableSeats(){
        flight.addPassenger(firstClass);
        assertEquals(463, flight.getAvailableSeats(plane1));
    }
